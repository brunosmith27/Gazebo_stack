...
class PathGenerator(Node):
    ...
    def run(self):
        try:
            ...
            self.load_and_concatenate_waypoints("primary_zigzag_path_waypoints.csv","secondary_zigzag_path_waypoints.csv","tertiary_zigzag_path_waypoints.csv","combined_zigzag_path_waypoints.csv")
